  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      <div
        className={
          isOpened
            ? `bg-white text-black p-2 md:p-6 h-[95%] w-[90%] rounded-lg md:w-[45%] md:h-[60%] max-w-lg flex flex-col justify-center items-center  gap-4 md:gap-4 relative overflow-y-scroll`
            : `bg-white text-black p-2 md:p-6 rounded-lg h-[80%] w-[90%] md:w-[45%] md:h-[45%] max-w-lg flex flex-col justify-center items-center  gap-4 md:gap-8 relative overflow-y-scroll`
        }
      >
        <button
        ...
        <p className="text-sm md:text-lg w-3/4 md:w-[95%]">
